...
class VisitControllerTest {
    ...
    void setUp() {
        ...
        setPetAndOwner(petId, ownerId);
        setUriVariable(petId, ownerId);
    ...
    private void setUriVariable(Long petId, Long ownerId) {
        uriVariables.clear();
    ...
    private void setPetAndOwner(Long petId, Long ownerId) {
